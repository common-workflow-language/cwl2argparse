...
inputs:
  ...
  - id: "#inputBam_HaplotypeCaller"
    type: File
    description: bam f produced after printReads
    inputBinding:
      position: 6 
      prefix: "-I"
    secondaryFiles:
  ...
  - id: "#outputfile_HaplotypeCaller"
    type: ["null", string]
    description: name of the output f from HaplotypeCaller
    inputBinding:
      position: 8
      prefix: "-o"
  ...
  - id: "#useAllelesTrigger"
    type: ["null", boolean]
    description: Use additional trigger on variants found in an external alleles f
    inputBinding:
      position: 10
  ...
  - id: "#graphOutput"
    type: ["null", File]
    description: Write debug assembly graph information to this f
    inputBinding:
      position: 33
      prefix: "--graphOutput"
  ...
  - id: "#activeRegionOut"
    type: ["null", File]
    description: Output the active region to this IGV formatted f
    inputBinding:
      position: 55
